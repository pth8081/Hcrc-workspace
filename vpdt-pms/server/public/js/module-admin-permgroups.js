...
const PERM_KEY_VN_LABELS = {
  ...
  "checklistReportViewScope.all": "Checklist Đánh Giá Siêu Thị — 📊 Xem Báo Cáo Checklist — ALL (xem được mọi mẫu, không giới hạn theo mẫu cụ thể)",
  "checklistStoreSelfExecute": "Checklist Đánh Giá Siêu Thị — ✅ Đánh Giá Checklist (Tự Đánh Giá — chỉ dạng câu hỏi, đúng siêu thị đang gán)",
  "checklistStoreSelfExecuteScope.all": "Checklist Đánh Giá Siêu Thị — ✅ Đánh Giá Checklist (Tự Đánh Giá) — ALL (làm được mọi mẫu Tự Đánh Giá, không giới hạn theo mẫu cụ thể)",
