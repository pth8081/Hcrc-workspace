...
function updateHrNavVisibility() {
  ...
  document.getElementById('hrNavWrap').classList.toggle('hidden', !feedbackVisible && !orgChartVisible && !lifecycleVisible && !profileVisible && !contractVisible);
}
