...
const SYSTEM_DOCS = {
  ...
  sysPermMatrix: {
    ...
    steps: [
      ...
      { role: 'Quản trị viên', text: 'mở file Excel vừa tải: mỗi cột quyền có TÊN TIẾNG VIỆT đúng như nhãn checkbox thật ở cây phân quyền (VD "Hành Chính &gt; Đăng Ký Xe", "Đăng Ký Xe — Người Điều Hành Xe...") — gõ <b>TRUE</b>/<b>FALSE</b> để bật/tắt. Quyền hiếm chưa có nhãn tiếng Việt vẫn hiện được, chỉ ở dạng kỹ thuật <b>"Q_&lt;tên quyền&gt;"</b>. Cột "NhomPhanQuyen" (sheet Người Dùng) và "BaoCao_MucBoSung" (cả 2 sheet) nhận nhiều giá trị cách nhau bằng dấu <b>;</b>. KHÔNG đổi cột đầu tiên (Username/TenNhom) — đó là khoá để hệ thống nhận diện đúng ai/nhóm nào.' },
