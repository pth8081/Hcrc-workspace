...
const SYSTEM_DOCS = {
  ...
  sysAdvWorkflow: {
    ...
    steps: [
      ...
      { role: 'Quản trị viên', text: 'ở THANH TAB TRÊN CÙNG (dính khi cuộn) ngay bên trong màn Hệ Thống, chọn 1 trong 5 sub-tab: <b>🏬 Quy Trình Đặt Hàng Siêu Thị</b> (ai duyệt từng bước đơn "Đặt Hàng Tại Siêu Thị", số bước vẫn cấu hình ở "Quy Trình & Phê Duyệt"), <b>⚡ Áp Dụng Nhanh</b> (set nhanh số bước cho nhiều module cùng lúc), <b>🖋️ Nhóm Phê Duyệt Trình/HĐ</b> (nhóm phê duyệt tuỳ chọn cho Văn Bản Trình + Hợp Đồng), <b>🧩 Nhóm Quyền Đặc Biệt</b> (Đơn Vị Tham Gia Quy Trình/Nhóm Không Cấp VPP/Vị Trí Tham Gia Quy Trình), hoặc <b>🖊️ Nhóm Phê Duyệt Cuối</b> (cùng cơ chế Nhóm Phê Duyệt Trình/HĐ nhưng cho 10 quy trình KHÁC, xem mục riêng ngay dưới).' },
      { role: 'Quản trị viên', text: 'mỗi sub-tab có nút <b>"💾 Lưu"</b> RIÊNG cho đúng phần đang sửa — không có nút Lưu chung cho cả 5 mục, đổi 1 mục không ảnh hưởng các mục còn lại.' },
      ...
      { role: 'Quản trị viên', text: '<b>"🖊️ Nhóm Phê Duyệt Cuối"</b> (10/2026): chọn 1 trong 10 quy trình ở dropdown đầu màn (📂 Tài Liệu, 🚗 Đăng Ký Xe, 🛒 Mua Bán VP, 🔧 Sửa Chữa VP, 🖇️ Văn Phòng Phẩm, 💰 Thanh Toán, 🏷️ Phê Duyệt Giá Bán Lẻ, 🏪 Phê Duyệt Giá Bán Buôn, 📦 Vận Hành - Đặt Hàng Tại Siêu Thị, 📦 Vận Hành - Đặt Hàng Tại HO — LOẠI TRỪ Hợp Đồng/Văn Bản Trình vì 2 quy trình đó dùng đúng sub-tab "🖋️ Nhóm Phê Duyệt Trình/HĐ" ở trên) — mỗi quy trình có bảng <b>Nhóm</b> (vai trò + thành viên gán sẵn, VD "Cấp Phê Duyệt Cuối Cùng") và bảng <b>Cấp</b> (mỗi Cấp quyết định Nhóm nào BẮT BUỘC/ĐƯỢC CHỌN THÊM) HOÀN TOÀN riêng, y hệt thao tác ở "🖋️ Nhóm Phê Duyệt Trình/HĐ". Khi form tạo hồ sơ của đúng quy trình đó, người tạo chọn 1 Cấp Phê Duyệt Cuối Cùng rồi tick thêm các Nhóm Phê Duyệt cần thiết — hệ thống tự nối thêm các bước này vào SAU CÙNG quy trình duyệt phòng ban gốc, không thay thế quy trình gốc.' },
    ],
    footer: { left: [
      { label: 'Không phải 1 nhóm quyền', text: '5 mục này KHÔNG liên quan tới nhau về mặt dữ liệu (mỗi mục 1 bảng AppData riêng) — gom chung 1 tab chỉ vì cùng thuộc phạm trù "cấu hình quy trình/duyệt nâng cao", giúp dễ tìm hơn so với trước.' },
      { label: 'Nhóm Phê Duyệt Cuối — 10 quy trình ĐỘC LẬP hoàn toàn', text: 'khác "🖋️ Nhóm Phê Duyệt Trình/HĐ" (2 quy trình dùng CHUNG khái niệm nhưng vẫn 2 bộ dữ liệu riêng), 10 quy trình ở "🖊️ Nhóm Phê Duyệt Cuối" mỗi quy trình 1 bộ Nhóm/Cấp RIÊNG 100% — đổi cấu hình của 1 quy trình không ảnh hưởng 9 quy trình còn lại. Quy trình nào CHƯA cấu hình đủ cả 2 bảng thì form tạo hồ sơ KHÔNG hiện thêm gì (an toàn tuyệt đối, giữ nguyên hành vi cũ).' },
    ], right: [
