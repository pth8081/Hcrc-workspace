...
// ==========================================================================
// Regression suite: "Bảo mật tài khoản khoá + Danh mục Sửa/Import" — covers
// the CLIENT-side behavior of the 3 requirements below. Originally also
// covered a 4th requirement (the "Quản Lý Nhân Viên Siêu Thị" sub-tab in
// Đồng Phục) — that sub-tab was REMOVED entirely (xem VERSION.md), including
// routes/uniformEmployees.js, so its scenarios were removed from this file
// too (file renamed from test-catalog-rename-uniform-employees.js to match
// what's left):
...
// onStoreImportFileChange, confirmStoreImport) exactly as the real UI wires
// them up — only the network layer is faked.
//
// Run: node server/tests/test-catalog-rename-locked-accounts.js
// ==========================================================================
