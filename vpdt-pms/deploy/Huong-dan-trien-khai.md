...
mật tầng hệ điều hành). Mô tả nghiệp vụ + hướng dẫn sử dụng/cấu hình các tính
năng nghiệp vụ, API, báo cáo của ứng dụng nằm ở
...
phải cập nhật vào file này — xem `CLAUDE.md` ở gốc repo.
